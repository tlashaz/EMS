    ...
    <form id="form1" runat="server">
     <!---strat-wrap---->
        ...
        <div class="loginform">
	        ...
	        <table>
                <tr>
                   <asp:TextBox ID="uname" runat="server" Font-Italic="true" BackColor="#353535" BorderStyle="None"></asp:TextBox>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="login" runat="server" Text="Login" OnClick="login_Click" ForeColor="WhiteSmoke" BackColor="#353535" BorderStyle="None" ToolTip="Login" Height="30" Width="80" />
              <br /><br /> <br />
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
